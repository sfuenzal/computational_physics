...
int main()
{
    ...
    strassen_multiplication_matrix(A,B,n); 
    ...
    times_file_1.open ("times_file_1.txt", ios::app | ios::ate);
    times_file_1 << "Time taken by program is : " << fixed  << time_taken << setprecision(10) << endl; 
    times_file_1.close(); 
